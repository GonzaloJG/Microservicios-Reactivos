...
* [Spring Data R2DBC](https://docs.spring.io/spring-boot/docs/3.2.10/reference/htmlsingle/index.html#data.sql.r2dbc)
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.2.10/reference/htmlsingle/index.html#messaging.kafka)
